...
public class AliPayTools {
    ...
    public static void aliPay(final Activity activity, String appid, boolean isRsa2,  String alipay_rsa_private,
                              AliPayModel aliPayModel, onRequestListener onRxHttp1) {
        sOnRequestListener = onRxHttp1;
        Map<String, String> params = AliPayOrderInfoUtil.buildOrderParamMap(appid, isRsa2,
                aliPayModel.getOut_trade_no(), aliPayModel.getName(), aliPayModel.getMoney(),
