...
public class PieChartFragment extends DemoBase implements OnChartValueSelectedListener {
    ...
    private List<ChartBean> mBeanList = new ArrayList<>();
    float sumEarn = 0;
...
//        setData(4, 100);
    ...
    private void setData(List<ChartBean> list) {
        ...
        for (ChartBean bean : list) {
            entries.add(new PieEntry(bean.value, bean.carNo,
                    getResources().getDrawable(R.drawable.ic_country_blue_24dp)));
        }

        PieDataSet dataSet = new PieDataSet(entries, "");//显示列表项文字
    ...
    public void setRouteList(List<Object> routeList) {
