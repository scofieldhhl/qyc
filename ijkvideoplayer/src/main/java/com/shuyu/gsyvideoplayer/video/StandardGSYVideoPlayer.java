...
//        enPlayView.setDuration(500);
        ...
        if (mCurrentState == CURRENT_STATE_PLAYING) {
            enPlayView.setImageResource(R.drawable.ic_video_pause);
            //mStartButton.setImageResource(R.drawable.video_click_pause_selector);
        } else if (mCurrentState == CURRENT_STATE_ERROR) {
            enPlayView.setImageResource(R.drawable.ic_video_play);
    ...
    protected void showProgressDialog(float deltaX, String seekTime, int seekTimePosition, String totalTime, int totalTimeDuration) {
        ...
        if (deltaX > 0) {
            ...
            mDialogTotalTime.setText(" + " + CommonUtil.stringForTime((int)(deltaX / 20) * 1000));
        } else {
            mDialogIcon.setBackgroundResource(R.drawable.video_backward_icon);
            mDialogTotalTime.setText(" - " + CommonUtil.stringForTime((int)(0 - deltaX / 20) * 1000));
        }
        //
