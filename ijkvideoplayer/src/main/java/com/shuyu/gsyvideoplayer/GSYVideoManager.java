...
public class GSYVideoManager implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener,
        MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnSeekCompleteListener, MediaPlayer.OnErrorListener,
        MediaPlayer.OnVideoSizeChangedListener, MediaPlayer.OnInfoListener, CacheListener {
    ...
    private void initIJKPlayer(Message msg) {
        ...
        try {
            ...
            (mediaPlayer).setDataSource(((GSYModel) msg.obj).getUrl());
...
//            mediaPlayer.setSurface(null);
            return;//Java.lang.IllegalStateException  mediaPlayer 已经release
        } else {
    ...
    public boolean onError(MediaPlayer mp, final int what, final int extra) {
        Debuger.printfLog("onError:" + " what:" + what + " extra:" + extra);
        /*mainThreadHandler.post(new Runnable() {
            @Override
            public void run() {
                if (listener != null) {
